...
export default {
  ...
  watch: {
    ...
    // },
    value(data) {
      if (data.SourceTableNo) {
        console.log(data);
      } else {
        this.value.SourceTable = "0";
  ...
  methods: {
    ...
    typeChange() {},
    add() {
      if (this.value.OutWarehouseId || this.value.WarehouseId) {
        this.$emit(
          "addbtn",
          this.tabsindex,
          this.value.OutWarehouseId,
          this.value.WarehouseId
        );
      } else if (this.value.InStockDate || this.value.Dept) {
        this.$emit(
          "addbtn",
          this.tabsindex,
          this.value.OutWarehouseId,
