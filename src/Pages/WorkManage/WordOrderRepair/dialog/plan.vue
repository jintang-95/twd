              ...
              <el-row :gutter="20">
                  <el-col :span="8">
                    <el-form-item label="计划类型" label-width="100px">
                        <el-select v-model="form.Dept" :disabled="type == 3" placeholder="请选择计划类型">
                            <el-option v-for="(item, index) in organList" :label="item.Name" :key="index" :value="item.Id">{{item.Name}}</el-option>
                        </el-select>
                    </el-form-item>
                  </el-col>
  ...
  data() {
    return {
        ...
        inventoryLabel: [
            ...
            // { label: '类型', param: 'Type',  align: 'center', sortable: false},
            { label: '执行人', param: 'ResponsiblerName',  align: 'center', sortable: false},
            { label: '开始时间', param: 'StartDate',  align: 'center', sortable: false},
            { label: '结束时间', param: 'EndDate',  align: 'center', sortable: false},
            // { label: '资源', param: 'resources',  align: 'center', sortable: false},
