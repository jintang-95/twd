  ...
  watch: {
    ...
    GetUselessApplyByNo(newVal, oldVal) {
      ...
      if (newVal.Code == 0) {
        ...
        this.formData.Status=newVal.ReturnData.Status
        this.formData.Abstracts=newVal.ReturnData.Reason
        this.formData.Addtime=newVal.ReturnData.CreatedTime
        this.formData.Name=newVal.ReturnData.CreateUserName
