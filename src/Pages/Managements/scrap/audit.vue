...
<template>
  <div class="materiaType">
    ...
    <el-dialog class="ModalForm" width="50%" :visible.sync="modal12" :destroy-on-close="true" scrollabel title="新增报废审核单">
      <PopForm
        ref="PopForm"
        @addbtn="addbtn"
        :fromData="fromData"
    ...
    <el-dialog :destroy-on-close="true" class="ModalForm" width="460px" :visible.sync="modal13" scrollabel title="报废审核物料新增">
