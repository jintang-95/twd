...
<template>
  <div>
      ...
      <el-row>
        ...
        <el-col :span="8">
          <div class="grid-content bg-purple">
            ...
            <span style="font-size: 14px;color: #798B97 ;">{{seeMsg[0].WarehouseName}}</span>
          </div>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        <el-col :span="8">
          <div class="grid-content bg-purple">
            ...
            <span style="font-size: 14px;color: #798B97 ;">{{seeMsg[0].Remark}}</span>
          </div>
        </el-col>
      </el-row>
    </div>
    ...
    <div class="tabs_body">
      <!-- <div class="tabs_body" v-if="showTabs==true"> -->
...
export default {
  ...
  created() {
    this.InitValue();
    console.log(this.seeMsg);
    let length = this.fromData.tabPane[0].columns.length - 1;
    console.log(this.fromData.tabPane[0].columns[length].title);
    if (this.fromData.tabPane[0].columns[length].title == "操作") {
      this.fromData.tabPane[0].columns.pop();
    }
  },
  //生命周期 - 挂载完成（访问DOM元素）
  mounted() {},
