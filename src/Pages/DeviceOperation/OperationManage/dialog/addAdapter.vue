...
export default {
  ...
  data() {
    return {
        ...
        inventoryLabel: [
            { label: '资产编码', param: 'AssetNo',  align: 'center', sortable: false},
            { label: '资产名称', param: 'AssetName',  align: 'center', sortable: false},
            ...
            { label: '所属部门', param: 'DeptName',  align: 'center', sortable: false},
  ...
  watch: {
      GetInventoryPlans(newVal, oldVal) {
          if (newVal.Code == 0) {
              ...
              this.total = this.form.hasOwnProperty('AdjustmentDetail') ? this.form.AdjustmentDetail.length : 0
          }
      },
