        ...
        <el-table-column label="操作" width="300" align="center">
          <template slot-scope="scope">
            <div v-if="scope.row.Status == 0">
              ...
              >
                <el-button class="operationTtn" slot="reference" type="text" size="small">
                  <img src="../../../assets/images/del_icon.png" alt />
                  <span>删除</span>
                </el-button>
              </el-popconfirm>
              <el-button type="text" size="small" class="operationTtn" style="margin-left: 0;" @click="start(scope.row)">
