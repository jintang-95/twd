  ...
  >
    <div>
      ...
      >
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item label="备件编码" prop="No" label-position="left">
              <el-input v-model="form.No" placeholder="请输入备件编码"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="备件名称" prop="Name" label-width="100px" label-position="left">
              <el-input v-model="form.Name" placeholder="请输入备件名称"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="备件分类" prop="CategoryId" label-width="100px">
              <!-- <el-select v-model="form.CategoryId" placeholder="请选择备件分类">
                <el-option
        ...
        emitPath:false,
          ...
          <el-col :span="8">
            <el-form-item label="默认供应商" prop="DefaultSupplierName" label-width="100px">
              <!-- <el-select
                disabled="disabled"
        ...
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item label="规格" prop="Spec" label-position="left" label-width="100px">
              <el-input v-model="form.Spec" placeholder="请输入规格"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="型号" prop="Model" label-position="left" label-width="100px">
...
border-radius:2px;"
        ...
        <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
          <el-tab-pane label="替代件" name="replace">
            <div class="replaceList">
              <el-table
                ...
                style="width: 100%"
              >
                <el-table-column align="center" prop="Name" label="备件名称"></el-table-column>
                <el-table-column align="center" prop="No" label="备件编号"></el-table-column>
                ...
                <el-table-column align="center" prop="Price" label="单价" width="220">
                  <template slot-scope="scope">
                    <el-input
          ...
          <el-tab-pane label="备件清单" name="materielList">
            <table-cmp
              style="width:100%"
              class="table_cmp"
              :loading="loading"
...
var process = {
  template: `<div>
            <el-button type="text"  size="small" class="operationTtn"  @click="edit()"><img src="../../../assets/images/edit_icon.png" alt />
                  <span>编辑</span></el-button>
            <el-button type="text" size="small" class="operationTtn" @click="del()"><img src="../../../assets/images/del_icon.png" alt />
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        No: [{ required: true, message: "请输入备件编码", trigger: "blur" }],
        Name: [{ required: true, message: "请输入备件名称", trigger: "blur" }],
        CategoryId: [
          { required: true, message: "请输入备件分类", trigger: "change" },
        ],
        StandardUnitId: [
