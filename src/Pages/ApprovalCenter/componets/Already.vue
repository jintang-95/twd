...
<template>
  <div class="lazyBox" ref="lazyBox" id="lazyBox">
    <div class="nullArray" v-if="cardList && cardList.lenght<0">还没有审批过</div>
