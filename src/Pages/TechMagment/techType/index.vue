...
export default {
  ...
  computed: {
    ...mapGetters([
      ...
      "GetListTechnologyTypeByParentId",
      "DelTechnologyType",
      "SaveTechnologyType",
      "GetSingleTechnologyType",
    ]),
  },
  watch: {
    GetListTechnologyTypeTree: {
    ...
    async DelTechnologyType(newValue, oldValue) {
      if (newValue.Code === 0) {
        this.$message({
          showClose: true,
          message: "操作成功",
    ...
    async SaveTechnologyType(newValue, oldValue) {
      if (newValue.Code === 0) {
        this.$message({
          showClose: true,
          message: "保存成功",
  ...
  methods: {
    ...
    getTableData() {
      let json = {
        SN:'Technology',
        MN: "GetListTechnologyTypeByParentId",
        DataContent: {
