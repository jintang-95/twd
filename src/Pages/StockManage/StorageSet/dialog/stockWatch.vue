<template>
  <el-dialog @close="cancelSubmit" :title="'库存监控'" :visible.sync="show" width="897px" >
    <el-form ref="form" :rules="rules" :model="form" label-width="100px">
      <el-row :gutter="20">
        <el-col :span="7">
          <el-form-item label="监控频率" prop="Frequency" label-position="left" class="FormItem">
            <el-input v-model="form.Frequency" placeholder="请输入监控频率"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="7">
          <el-form-item label="监控频率" prop="Unit" label-position="left" class="FormItem">
        ...
        <el-col :span="8">
          ...
          -->
          <el-form-item label="通知人" label-position="left"  prop="NotifiedByName">
            <el-select
              v-model="form.NotifiedByName"
              @change="selectChange"
              filterable
              remote
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item prop="Mobile" label-position="left" label="手机号">
...
border-radius:2px;"
    ...
    <span slot="footer"  style="  margin-left: 38.1rem;" class="dialog-footer">
...
height:32px;font-size:14px;background:rgba(0,96,160,1);line-height: 16px; color:#fff;outline: none;" @click="submitData" >确 定</button>
    ...
    <add-materiel
      :visible="showMask"
      :type="formType"
      :allData="form.StockMonitorDetail"
      :addData="maskData"
...
export default {
  ...
  data() {
    return {
      rules: {
        Frequency: [{ required: true, message: "请输入监控频率", trigger: "blur" }],
        Unit: [{ required: true, message: "请选择", trigger: "change" }],
        NotifiedByName: [
          { required: true, message: "请输入通知人姓名", trigger: "change" },
        ],
        Mobile: [
      ...
      shelevsLabel: [
        ...
        { label: "操作", align: "center", component: process },
      ],
      watchList: [
        {
          label: "年",
