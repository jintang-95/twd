              ...
              <el-row :gutter="20">
                <el-col :span="8">
                    <el-form-item label="负责部门" label-width="100px" label-position="left">
                        <el-select v-model="form.ResponsibleDeptName" @change="deptChange" :disabled="type == 3" filterable remote :remote-method="getOrganList" placeholder="请输入负责部门搜索">
                ...
                <el-col :span="8">
                    <el-form-item label="负责岗位" label-width="100px">
                        <el-select v-model="form.JobsName"  @change="jobChange" :disabled="type == 3" filterable remote :remote-method="getJobList" placeholder="请输入负责岗位搜索">
