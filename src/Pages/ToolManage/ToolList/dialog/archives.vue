  ...
  >
    <div>
      ...
      >
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item label="工具编码" prop="No" label-position="left">
              <el-input v-model="form.No" placeholder="请输入工具编码"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="工具名称" prop="Name" label-width="100px" label-position="left">
              <el-input v-model="form.Name" placeholder="请输入工具名称"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="工具分类" prop="CategoryId" label-width="100px">
        ...
        emitPath:false,
          ...
          <el-col :span="8">
            <el-form-item prop="DefaultSupplierName" label="默认供应商" label-width="100px">
              ...
              <chooseSupplier :SupplierId="SupplierId" :isMultipleChoice="false" @getToFather='getToFather' style="width=300px;margin-top:-.5rem;"></chooseSupplier>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
...
border-radius:2px;"
        ...
        <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
          <el-tab-pane label="替代件" name="replace">
            <div class="replaceList">
              <el-table
                ...
                style="width: 100%"
              >
                <el-table-column align="center" prop="Name" label="工具名称"></el-table-column>
                <el-table-column align="center" prop="No" label="工具编号"></el-table-column>
          ...
          <el-tab-pane label="工具清单" name="materielList">
            <table-cmp
              style="width:100%"
              class="table_cmp"
              :loading="loading"
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        No: [{ required: true, message: "请输入工具编码", trigger: "blur" }],
        Name: [{ required: true, message: "请输入工具名称", trigger: "blur" }],
        CategoryId: [
          { required: true, message: "请输入工具分类", trigger: "change" },
        ],
        StandardUnitId: [
