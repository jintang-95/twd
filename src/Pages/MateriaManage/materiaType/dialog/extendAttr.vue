<template>
  <el-dialog
    ...
    append-to-body
  >
    <el-form ref="form" label-width="80px" :rules="rules" label-position="left">
      <el-form-item label="属性名"  prop="Name" label-position="left">
        <el-input placeholder="请输入属性名" v-model="formData.Name"></el-input>
      </el-form-item>
      <el-form-item label="属性值" prop="Value" label-position="left">
